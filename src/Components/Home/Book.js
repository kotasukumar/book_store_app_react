...
const Book=(props)=>{
    ...
    useEffect(()=>{
        CartService.getUserCart(localStorage.getItem('id')).then((result)=>{
                    ...
                    {props.bookArray.map(book => <Card sx={{ maxWidth: 300, background: "#F5F5F5", minHeight: 10 }} style={{ "marginTop": "20px", margin: "20px", "marginLeft": "50px" }}>
                        {book.quantity === 0 ?
                            <Box sx={{ "margin": 5, "marginTop": 0 }}>
                                <img src={book.bookImage} alt={book.bookName} width="100" height="200" style={{ "marginTop": "5px" }} />
                            ...
                            :
                            <img src={book.bookImage} alt={book.bookName} width="100" height="200" style={{ "marginTop": "50px", margin: "20px" }} />
                        }
